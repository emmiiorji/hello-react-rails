...
# 📖Hello Reat/Rails App <a name="about-project"></a>

A project to demonstrate setting up a Ruby on Rails project as one app with Webpack with the `jsbundling-rails` gem.
